    ...
    { title: "まずはこれ ・ 1つで完結するメイン拠点",
      ...
      items: [
        { id: "main-early", icon: "🏕", name: "序盤のメイン拠点",
          desc: "序盤に捕まえられるパルだけ。作業台1・炉1・伐採場1・採掘場1を置いた前提",
          tier: "early", slots: 10,
          w: { 手作業: 3, 運搬: 3, 採集: 2, 伐採: 2, 採掘: 2, 種まき: 2, 水やり: 2, 火おこし: 2, 牧場: 1 },
          caps: { 手作業: 3, 火おこし: 1, 伐採: 2, 採掘: 2 } },   /* 作業台1・炉1・伐採場1・採掘場1 */

        { id: "main-mid", icon: "🏘", name: "中盤のメイン拠点",
          desc: "中盤までのパルで12役職を埋める。作業台2・炉2・伐採場2・採掘場2の前提",
          tier: "mid", slots: 15,
          w: { 手作業: 3, 運搬: 3, 火おこし: 2, 水やり: 2, 種まき: 2, 採集: 2,
               伐採: 2, 採掘: 2, 製薬: 2, 冷却: 2, 発電: 2, 牧場: 1 },
          caps: { 手作業: 6, 火おこし: 2, 伐採: 4, 採掘: 4 } },   /* 作業台2・炉2・伐採場2・採掘場2 */

        { id: "main-late", icon: "🏰", name: "終盤のメイン拠点",
          desc: "配合・ボス限定も使う完成形。作業台3・炉3・伐採場3・採掘場3の前提",
          tier: null, slots: 20,
          w: { 手作業: 3, 運搬: 3, 火おこし: 3, 水やり: 2, 種まき: 2, 採集: 2,
               伐採: 2, 採掘: 2, 製薬: 3, 冷却: 2, 発電: 2, 牧場: 1 },
          caps: { 手作業: 9, 火おこし: 3, 伐採: 6, 採掘: 6 } },   /* 作業台3・炉3・伐採場3・採掘場3 */
      ] },
